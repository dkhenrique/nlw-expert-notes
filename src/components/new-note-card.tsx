...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  return (
    ...
    <Dialog.Trigger className='flex flex-col gap-3 text-left rounded-md bg-slate-700 p-5 overflow-hidden  hover:ring-2 outline-none hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
          ...
          <Dialog.Content className='fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 md:-translate-y-1/2 md:-translate-x-1/2 md:max-w-[640px] md:h-[60vh] w-full bg-slate-700 md:rounded-md flex flex-col outline-none overflow-hidden'>
            ...
            <form className='flex-1 flex flex-col'>
              ...
              {isRecording ? (
                ...
                >
                  <div className='size-3 rounded-full bg-red-500 animate-puls' />
